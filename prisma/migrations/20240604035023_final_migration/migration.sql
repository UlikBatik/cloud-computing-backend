...
CREATE TABLE `Batik` (
    ...
    `BATIKLOCT` VARCHAR(50) NOT NULL,
    `BATIKDESC` VARCHAR(500) NOT NULL,
    `BATIKHIST` VARCHAR(800) NOT NULL,
    `BATIKIMG` VARCHAR(255) NOT NULL,

    INDEX `Batik_BATIKID_idx`(`BATIKID`),
    FULLTEXT INDEX `Batik_BATIKNAME_idx`(`BATIKNAME`),
    FULLTEXT INDEX `Batik_BATIKNAME_BATIKDESC_BATIKHIST_BATIKLOCT_idx`(`BATIKNAME`, `BATIKDESC`, `BATIKHIST`, `BATIKLOCT`),
    PRIMARY KEY (`BATIKID`)
